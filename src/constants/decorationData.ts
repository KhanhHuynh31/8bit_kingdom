...
export const DECO_5: DecoBuilding[] = [
  {
    ...
    description: "Cây hoa anh đào nở rộ mỗi mùa xuân, thu hút chim muông.",
    tileW: 3,
    tileH: 3,
    imageSrc: "/assets/gacha/anh_dao.png",
    cardSrc: "/assets/gacha/anh_dao.png",
  },
  {
    kind: "decoration",
    id: "dai_phun",
    rarity: 5,
    name: "Đài phun nước",
    description: "Đài phun nước với thiết kế tinh xảo, tạo nên một điểm nhấn sang trọng cho khu vườn.",
    tileW: 3,
    tileH: 3,
    imageSrc: "/assets/gacha/dai_phun.png",
    cardSrc: "/assets/gacha/dai_phun.png",
  },
    {
    kind: "decoration",
    id: "ghe",
    rarity: 5,
    name: "Ghế",
    description: "Ghế ngồi với thiết kế tinh xảo, tạo nên một điểm nhấn sang trọng cho khu vườn.",
    tileW: 3,
    tileH: 3,
