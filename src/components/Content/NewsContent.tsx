...
import { Megaphone, Scroll, Info, AlertTriangle, Hammer, Calendar, Sparkles } from 'lucide-react';
    ...
    <div className="space-y-10 animate-in fade-in zoom-in-95 duration-700 pb-10">
      ...
      <div className="space-y-4 mx-2">
        {newsList.map((news) => (
          ...
          >
            {/* Tag Phân Loại ở góc */}
            <div className={`absolute top-0 right-0 px-3 py-1 text-[9px]  tracking-widest uppercase border-l border-b border-[#3a2810] ${news.color} bg-[#161009]/80`}>
              {news.tag}
            </div>
            ...
            <div className="flex-1 pr-10 sm:pr-0">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[10px] text-[#6b4c1e] uppercase tracking-wider">{news.date}</span>
              </div>
