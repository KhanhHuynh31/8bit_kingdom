...
import { BauCuaPopup } from "../arena/BauCuaGame";
const GAMES_DATA = [
  {
    id: "blackjack",
    title: "Vũ trụ 21",
    desc: "Đặt cược và thử vận may của bạn trong trò chơi bài kinh điển, nơi bạn phải đánh bại nhà cái mà không vượt quá 21 điểm!",
    icon: Dices,
    ...
    id: "baucua",
    title: "Vũ trụ 6",
    desc: "Chọn biểu tượng may mắn có thể xuất hiện trên 3 thẻ bài ngẫu nhiên, nếu trùng khớp, bạn sẽ thắng lớn!",
    icon: Dices,
    imageSrc: "/assets/games/6.png",
    hot: true,
  },
];
      ...
      <div className="space-y-10 animate-in fade-in duration-700 custom-scrollbar max-h-[70vh]">
        ...
        <div className="space-y-6">
          <div className="flex justify-between px-1">
            ...
            <div className="text-[#f0d882] text-xs font-mono">
              WALLET: {avocados.toLocaleString()} 🥑
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {GAMES_DATA.map((game) => (
              <div
                key={game.id}
                className="group relative bg-[#1a1208] border border-[#3a2810] hover:border-[#f0d882] transition-all p-4 rounded-sm"
              >
                <div className="relative h-32 mb-4 overflow-hidden">
                  ...
                  />
                  {game.hot && (
                    <div className="absolute top-2 left-2 bg-red-600 text-[8px] px-2 py-0.5 animate-pulse">
                      HOT
                    </div>
                  )}
                </div>
                <h5 className="text-[#e8c97a] text-sm font-bold uppercase mb-1">
                  {game.title}
                </h5>
                <p className="text-[#8b6530] text-[10px] italic mb-4 line-clamp-2">
                  {game.desc}
                </p>
                <button
